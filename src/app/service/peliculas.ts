...
export class PeliculasService {
  ...
  obtenerPeliculas() {
    return [
      ...
      { id: 1, titulo: 'Spider-Man: Across the Spider-Verse', precio: 15, genero: 'Animación / Acción', stock: 10, imagen: '' },
      { id: 2, titulo: 'Project Hail Mary', precio: 13, genero: 'Ciencia Ficción', stock: 5, imagen: '' },
      { id: 3, titulo: 'Obsession', precio: 11, genero: 'Drama / Thriller', stock: 7, imagen: '' },
      ...
      { id: 10, titulo: 'Avatar', precio: 14, genero: 'Ciencia Ficción / Acción', stock: 12, imagen: '' },
      { id: 11, titulo: 'The Drama', precio: 10, genero: 'Drama', stock: 4, imagen: '' },
      { id: 12, titulo: 'Jurassic World', precio: 13, genero: 'Aventura / Ciencia Ficción', stock: 9, imagen: '' },
